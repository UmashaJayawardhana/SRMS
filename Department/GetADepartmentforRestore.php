...
<head>
    ...
    <title>Restore Department</title>
...
<body>
    ...
    <div class="container">
        ...
        <?php 
                        ...
                        $department = "select DepID, DepCode from department where Status='Detele'";
      ...
      <a id="searchLink" class="myAddBtn" href="#">Search</a>
        ...
        $con = new mysqli('localhost','root','1234','srms');
        $sql = "select * from department where DepID=$DepartmentID and Status='Detele'";
        ...
        while($row = mysqli_fetch_assoc($result)){
                echo "<tr>";
                    ...
                    echo "<td>".$row['HOD']."</td>";
                    echo '<td><a class="myDeleteHistoryBtn" href="DeleteDepartmentRestore.php?DepID='.$row['DepID'].'">Restore</a></td>';
                echo "</tr>";
        }
?>
...
<script>
    document.getElementById('depcode').addEventListener('change', function() {
        ...
        searchLink.href = 'GetADepartmentforRestore.php?DepID=' + depID;
    });
</script>
</html>
