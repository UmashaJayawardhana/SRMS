...
<body>
    ...
    <div class="container">
        ...
        <?php 
                        ...
                        $department = "select DepID, DepCode from department where Status='Delete'";
      ...
      <a id="searchLink" class="myAddBtn" href="#">Search</a>
        ...
        $con = new mysqli('localhost','root','1234','srms');
        $sql = "select * from department where Status='Delete'";
        ...
        while($row = mysqli_fetch_assoc($result)){
                echo "<tr>";
                    ...
                    echo "<td>".$row['HOD']."</td>";
                    echo '<td><a class="myHistoryBtn" href="DeleteDepartmentRestore.php?DepID='.$row['DepID'].'">Restore</a></td>';
                echo "</tr>";
        }
?>
