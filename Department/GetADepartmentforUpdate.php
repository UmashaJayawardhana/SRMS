...
<body>
    ...
    $DepartmentID = $_GET['DepID'];
        ...
        $con = new mysqli('localhost','root','1234','srms');
        $sql = "select * from department where DepID=$DepartmentID Status='Insert'";
        ...
        while($row = mysqli_fetch_assoc($result)){
                echo "<tr>";
                    ...
                    echo "<td>".$row['HOD']."</td>";
                    echo '<td><a class="myUpdateBtn" href="UpdateFormDepartment.php?DepID='.$row['DepID'].'">Update</a></td>';
                echo "</tr>";
        }
?>
