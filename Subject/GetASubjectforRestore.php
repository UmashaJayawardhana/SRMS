...
<body>
    ...
    <h2>Subject</h2>
      ...
      <table id="SubjectsTable">
        ...
        $SubID = $_GET['SubID'];
        $con = new mysqli('localhost','root','1234','srms');
        $sql = "select * from subject where SubID=$SubID and Status='Detele'";
        ...
        while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<td><a class="myHistoryBtn" href="DeleteSubjectRestore.php?SubID='.$row['SubID'].'">Restore</a></td>';
                echo "</tr>";
        }
?>
...
<script>
    document.getElementById('code').addEventListener('change', function() {
        ...
        searchLink.href = 'GetASubjectforRestore.php?SubID=' + subID;
    });
</script>
</html>
