...
<body>
    ...
    <div class="container">
      ...
      <table id="batchTable">
        ...
        $con = new mysqli('localhost','root','1234','srms');
        $sql = "select * from batch where Status='Insert'";
        ...
        while($row = mysqli_fetch_assoc($result)){
                echo "<tr>";
                    ...
                    echo '<td><a class="myUpdateBtn" href=UpdateFormBatch.php?BatchID='.$row['BatchID'].'">Update</a></td>';
                echo "</tr>";
        }
?>
...
<script>
    document.getElementById('Batchcode').addEventListener('change', function() {
        ...
        searchLink.href = 'GetABatchforUpdate.php?BatchID=' + batchID;
    });
</script>
</html>
