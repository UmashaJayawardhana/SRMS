...
<head>
    ...
    <title>Edit Module Leader</title>
...
<body>
    ...
    $ModuleLeaderID = $_GET['ModuleLeaderID'];
        ...
        $con = new mysqli('localhost','root','1234','srms');
        $sql = "select * from moduleleader where ModuleLeaderID=$ModuleLeaderID Status='Insert'";
        ...
        while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<td><a class="myUpdateBtn" href="UpdateFormModuleLeader.php?ModuleLeaderID='.$row['ModuleLeaderID'].'">Update</a></td>';
                echo "</tr>";
        }
?>
...
<script>
    document.getElementById('name').addEventListener('change', function() {
        ...
        searchLink.href = 'GetAModuleLeaderforUpdate.php?ModuleLeaderID=' + moduleLeaderID;
    });
</script>
</html>
