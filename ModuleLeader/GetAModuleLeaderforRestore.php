...
<head>
    ...
    <title>Restore Module Leader</title>
...
<body>
    ...
    <div class="container">
      ...
      <table id="ModuleLeadersTable">
        ...
        $con = new mysqli('localhost','root','1234','srms');
        $sql = "select * from moduleleader where ModuleLeaderID=$ModuleLeaderID and Status='Detele'";
        ...
        while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<td><a class="myHistoryBtn" href="DeleteModuleLeaderRestore.php?ModuleLeaderID='.$row['ModuleLeaderID'].'">Restore</a></td>';
                echo "</tr>";
        }
?>
...
<script>
    document.getElementById('name').addEventListener('change', function() {
        ...
        searchLink.href = 'GetAModuleLeaderforRestore.php?ModuleLeaderID=' + moduleLeaderID;
    });
</script>
</html>
